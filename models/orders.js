...
class Orders {
  ...
  fetchCart(req, res) {
    const query = `SELECT prodName, quantity, price, prodUrl FROM Users INNER JOIN Orders ON Users.userID = Orders.userID INNER JOIN Products ON Orders.prodID = Products.prodID WHERE Orders.userID = Users.userID;`;
